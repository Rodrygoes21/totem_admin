...
export const totemSchema = Joi.object({
  ...
  activo: Joi.boolean().default(true),
  institucion_id: Joi.number().integer().positive().optional().allow(null),
  categoria_id: Joi.number().integer().positive().optional().allow(null),
  region_id: Joi.number().integer().positive().optional().allow(null),
  plantilla_id: Joi.number().integer().positive().optional().allow(null),
  login_sitio: Joi.string().min(3).max(100).optional().allow('', null),
  password_sitio: Joi.string().min(6).optional().allow('', null),
  chatpdf_url: Joi.string().uri().optional().allow('', null),
  contenido_texto: Joi.string().optional().allow('', null),
