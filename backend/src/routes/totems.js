...
const totemSchema = Joi.object({
  ...
  login_sitio: Joi.string().min(3).max(100).optional().allow(''),
  password_sitio: Joi.string().min(6).optional().allow(''),
  chatpdf_url: Joi.string().uri().optional().allow(''),
  contenido_texto: Joi.string().optional().allow(''),
